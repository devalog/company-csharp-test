...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<DevinApi.Core.ApiResponse> MakeRequestAsync(
        DevinApi.Core.BaseRequest request,
    ...
    internal async Task<DevinApi.Core.ApiResponse> SendRequestAsync(
        DevinApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<DevinApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new DevinApi.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(DevinApi.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(DevinApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use DevinApi.Core.ApiResponse instead.")]
    internal record ApiResponse : DevinApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use DevinApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : DevinApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use DevinApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : DevinApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use DevinApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : DevinApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use DevinApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : DevinApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use DevinApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : DevinApi.Core.StreamRequest;
}
